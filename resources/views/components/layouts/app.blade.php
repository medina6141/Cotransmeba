...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="overflow-x-hidden font-sans antialiased" x-data="app">
        ...
        <x-nav class="top-0 z-30" full-width
            x-bind:class="{
            ...
            <x-slot:actions>
                ...
                <x-theme-toggle class="btn btn-circle btn-ghost text-white" @theme-changed="()=>{setLogo()}" />
            </x-slot:actions>
        </x-nav>
        <main>
            {{ $slot }}
            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">© {{ date('Y') }} <a
                            class="hover:underline" href="https://flowbite.com/">Cotransmeba™</a>. Todos los derechos
                        reservados.
                    </span>
