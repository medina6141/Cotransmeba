<div class="mx-auto min-h-screen">
        ...
        <div class="prose mx-auto max-w-full">
            ...
            <div class="grid grid-cols-1 pt-14 md:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-users" />
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-battery-100" />
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-squares-2x2" />
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-light-bulb" />
                    <h3>Innovación</h3>
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-cube-transparent" />
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-lifebuoy" />
                    <h3>Colaboración</h3>
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-heart" />
                    <h3>Respeto</h3>
    ...
    <section class="relative mx-auto w-full max-w-screen-2xl px-8 pt-20">
        <div class="prose mx-auto max-w-full">
            ...
            <div class="grid grid-cols-1 pt-14 md:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-emerald-500 dark:text-base-100" name="o-map" />
                    <h3>Geografía</h3>
                ...
                <div class="col-span-2 p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-globe-americas" />
                    <h3>Biodiversidad</h3>
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    <x-icon class="h-14 w-auto text-orange-500 dark:text-base-100" name="o-arrow-trending-down" />
